...
replace (
	...
	github.com/super-phenix/superphenix/pkg/permify-wrapper => ./pkg/permify-wrapper
	github.com/super-phenix/superphenix/pkg/superphenix-id => ./pkg/superphenix-id
	github.com/super-phenix/superphenix/pkg/utils => ./pkg/utils
)
...
require (
	...
	github.com/backube/snapscheduler v1.2.0 // indirect
	...
	github.com/super-phenix/superphenix/pkg/permify-wrapper v0.0.0 // indirect
