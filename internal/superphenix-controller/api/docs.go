...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_super-phenix_superphenix_internal_superphenix-controller_internal_models_view.Bucket"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "github_com_super-phenix_superphenix_internal_superphenix-controller_internal_models_view.Bucket": {
            "type": "object",
            "properties": {
                "bucket": {
                    "$ref": "#/definitions/github_com_super-phenix_superphenix_internal_superphenix-controller_internal_models_view.BucketView"
                },
                "codeAZ": {
                    "type": "string"
                },
        ...
        "github_com_super-phenix_superphenix_internal_superphenix-controller_internal_models_view.BucketView": {
            "type": "object",
            "properties": {
                "creationTimestamp": {
                    "type": "string"
